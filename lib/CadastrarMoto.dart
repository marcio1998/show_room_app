...
class CadastrarMoto extends StatefulWidget {
  const CadastrarMoto({Key? key}) : super(key: key);

  @override
  _CadastrarMotoState createState() => _CadastrarMotoState();
}

class _CadastrarMotoState extends State<CadastrarMoto> {
  ...
  void cadastrarMoto(marca, modelo, ano, potencia, motor, urlImg) {
      ...
      db
          ...
          .then((value) => {
                ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                  content: Text("Moto cadastrada com Sucesso"),
